//
//  GiphySearchCollectionLayout.swift
//  GiphySearchApp
//
//  Created by Murat Sudan on 30/01/2021.
//

import UIKit

public protocol GiphySearchCollectionLayoutDelegate {
	func clearCache()
	func collectionView(_ collectionView: UICollectionView, heightForItemAt indexPath: IndexPath, with width: CGFloat) -> CGFloat
}

public class GiphySearchCollectionLayout: UICollectionViewLayout {
	
	//Public vars
	public var delegate: GiphySearchCollectionLayoutDelegate?
	...
	override public func prepare() {
		if cache.isEmpty {
			...
			for item in 0 ..< collectionView!.numberOfItems(inSection: 0) {
				...
				let cardHeight = delegate?.collectionView(collectionView!, heightForItemAt: indexPath, with: width) ?? 0.0
